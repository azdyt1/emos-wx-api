...
public class MeetingServiceImpl implements MeetingService {
    ...
    private void startMeetingWorkflow(String uuid, int creatorId, String title, String date, String start, String meetingType) {
    ...
    public void insertMeeting(TbMeeting entity) {
        ...
        startMeetingWorkflow(entity.getUuid(), entity.getCreatorId().intValue(), entity.getTitle(),entity.getDate(), entity.getStart(), meetingType);
    }
    ...
    public void updateMeetingInfo(HashMap param) {
        ...
        //创建新的工作流
        startMeetingWorkflow(uuid, creatorId, title, date, start, meetingType);
